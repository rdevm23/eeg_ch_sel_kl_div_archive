...
load('allranks_with_filter_sub_ind.mat');
...
for filt = 1:1
    ...
    parfor n_chs = 3:118
        ...
        ranks_of_sub = all_ranks.refs(2).ranks;
        ...
        for s = 1:n_subs
            ...
            classify_obj = cls_classify_with_filterbanks(...
            ...
            % Other Preprocessing
            classify_obj = classify_obj.csp_filtering(channel_selected,n_CSP_comp);
