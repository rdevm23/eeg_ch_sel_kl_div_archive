...
load('idx_ranks_Fishers_score_BCIC3_4a.mat');
...
for n_chs = 3:118
    ...
    channel_selected = index(1:n_channels);
    ...
    % avg_accuracy
    % trn_accuracy
    RESULTS_BCIC3_4A(n_chs).accuracy_results = accuracy_results;
    RESULTS_BCIC3_4A(n_chs).avg_results = avg_accuracy;
    RESULTS_BCIC3_4A(n_chs).channel_selected = channel_selected;
    
    RESULTS_BCIC3_4A(n_chs).trn_accuracy = trn_accuracy;
end
